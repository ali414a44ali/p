...
from VeGa.utils import get_readable_time
...
@app.on_message(filters.command(["gban", "globalban"]) & SUDOERS, group=544)
@language
...
@app.on_message(filters.command(["ungban"]) & SUDOERS, group=65444)
@language
...
@app.on_message(filters.command(["gbannedusers", "gbanlist"]) & SUDOERS, group=4332211)
@language
